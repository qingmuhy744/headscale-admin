...
<Page>
	<PageHeader title={$t('nodes.title')} layout={App.layoutNode} bind:show={showCreate} bind:filterString>
		{#snippet button()}
	...
	>
		...
		<SortBtn bind:value={sortMethod} direction={sortDirection} method="last seen" name={$t('common.lastSeen')} {toggle} />
	</div>
	<div
